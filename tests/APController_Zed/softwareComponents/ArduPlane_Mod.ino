...
//dynamic hardware API
#include <AP_DynamicHardware.h> //only compiles if ENABLE_DYNAMIC_HARDWARE flag is set

#ifdef ENABLE_DYNAMIC_HARDWARE 

	static AP_HAL::UARTDriver *dynamicHardwareUart;

	static AP_DynamicHardware *dynamicHardwareManager;
...
void setup() {
    ...
    init_ardupilot();
		...
		dynamicHardwareUart = hal.createUARTConnection(NULL,NULL);
		dynamicHardwareUart->begin(115200,256,256);
#endif //CONFIG_HAL_BOARD == HAL_BOARD_LINUX

		initDynamicHardwareModules(&ahrs, dynamicHardwareUart);
#endif //ENABLE_DYNAMIC_HARDWARE
