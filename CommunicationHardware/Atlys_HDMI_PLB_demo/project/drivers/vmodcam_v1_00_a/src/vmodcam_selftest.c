/*****************************************************************************
* Filename:          D:\Users\Julio\Downloads\Atlys_HDMI_PLB_demo\project/drivers/vmodcam_v1_00_a/src/vmodcam_selftest.c
* Version:           1.00.a
* Description:       Contains a diagnostic self-test function for the vmodcam driver
...
XStatus VMODCAM_SelfTest(void * baseaddr_p)
{
  ...
  VMODCAM_mWriteSlaveReg0(baseaddr, 0, 1);
  Reg32Value = VMODCAM_mReadSlaveReg0(baseaddr, 0);
  ...
  VMODCAM_mWriteSlaveReg1(baseaddr, 0, 2);
  Reg32Value = VMODCAM_mReadSlaveReg1(baseaddr, 0);
  ...
  VMODCAM_mWriteSlaveReg2(baseaddr, 0, 3);
  Reg32Value = VMODCAM_mReadSlaveReg2(baseaddr, 0);
  ...
  VMODCAM_mWriteSlaveReg3(baseaddr, 0, 4);
  Reg32Value = VMODCAM_mReadSlaveReg3(baseaddr, 0);
  ...
  VMODCAM_mWriteSlaveReg4(baseaddr, 0, 5);
  Reg32Value = VMODCAM_mReadSlaveReg4(baseaddr, 0);
  ...
  VMODCAM_mWriteSlaveReg5(baseaddr, 0, 6);
  Reg32Value = VMODCAM_mReadSlaveReg5(baseaddr, 0);
  ...
  VMODCAM_mWriteSlaveReg6(baseaddr, 0, 7);
  Reg32Value = VMODCAM_mReadSlaveReg6(baseaddr, 0);
  ...
  VMODCAM_mWriteSlaveReg7(baseaddr, 0, 8);
  Reg32Value = VMODCAM_mReadSlaveReg7(baseaddr, 0);
  ...
  {
    VMODCAM_mWriteMemory(LocalBRAM+4*Index, 0xDEADBEEF);
    Mem32Value = VMODCAM_mReadMemory(LocalBRAM+4*Index);
