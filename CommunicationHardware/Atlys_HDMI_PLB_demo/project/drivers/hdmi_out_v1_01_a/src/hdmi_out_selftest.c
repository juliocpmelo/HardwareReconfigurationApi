/*****************************************************************************
* Filename:          D:\Users\Julio\Downloads\Atlys_HDMI_PLB_demo\project/drivers/hdmi_out_v1_01_a/src/hdmi_out_selftest.c
* Version:           1.01.a
* Description:       Contains a diagnostic self-test function for the hdmi_out driver
...
XStatus HDMI_OUT_SelfTest(void * baseaddr_p)
{
  ...
  HDMI_OUT_mWriteSlaveReg0(baseaddr, 0, 1);
  Reg32Value = HDMI_OUT_mReadSlaveReg0(baseaddr, 0);
  ...
  HDMI_OUT_mWriteSlaveReg1(baseaddr, 0, 2);
  Reg32Value = HDMI_OUT_mReadSlaveReg1(baseaddr, 0);
  ...
  HDMI_OUT_mWriteSlaveReg2(baseaddr, 0, 3);
  Reg32Value = HDMI_OUT_mReadSlaveReg2(baseaddr, 0);
  ...
  HDMI_OUT_mWriteSlaveReg3(baseaddr, 0, 4);
  Reg32Value = HDMI_OUT_mReadSlaveReg3(baseaddr, 0);
  ...
  HDMI_OUT_mWriteSlaveReg4(baseaddr, 0, 5);
  Reg32Value = HDMI_OUT_mReadSlaveReg4(baseaddr, 0);
  ...
  HDMI_OUT_mWriteSlaveReg5(baseaddr, 0, 6);
  Reg32Value = HDMI_OUT_mReadSlaveReg5(baseaddr, 0);
  ...
  HDMI_OUT_mWriteSlaveReg6(baseaddr, 0, 7);
  Reg32Value = HDMI_OUT_mReadSlaveReg6(baseaddr, 0);
  ...
  HDMI_OUT_mWriteSlaveReg7(baseaddr, 0, 8);
  Reg32Value = HDMI_OUT_mReadSlaveReg7(baseaddr, 0);
  ...
  HDMI_OUT_mWriteSlaveReg8(baseaddr, 0, 9);
  Reg32Value = HDMI_OUT_mReadSlaveReg8(baseaddr, 0);
  ...
  HDMI_OUT_mWriteSlaveReg9(baseaddr, 0, 10);
  Reg32Value = HDMI_OUT_mReadSlaveReg9(baseaddr, 0);
