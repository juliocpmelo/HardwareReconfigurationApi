...
Peripheral Summary:
  ...
  logical library name                       : simple_video_filter_v1_00_a
  top name                                   : simple_video_filter
  version                                    : 1.00.a
  type                                       : PLB (v4.6) slave
...
- HDL source file(s)
  ...
  hdl/vhdl/simple_video_filter.vhd
...
- XPS interface file(s)
  ...
  data/simple_video_filter_v2_1_0.mpd
  ...
  data/simple_video_filter_v2_1_0.pao
...
- ISE project file(s)
  ...
  devl/projnav/simple_video_filter.ise
...
- XST synthesis file(s)
  ...
  devl/synthesis/simple_video_filter_xst.prj
...
-user needs to add these to repositories path in SDK (Xilinx Tools-->Repositories)
  ...
  data/simple_video_filter_v2_1_0.mdd

    This is the Microprocessor Driver Definition file.

  data/simple_video_filter_v2_1_0.tcl
