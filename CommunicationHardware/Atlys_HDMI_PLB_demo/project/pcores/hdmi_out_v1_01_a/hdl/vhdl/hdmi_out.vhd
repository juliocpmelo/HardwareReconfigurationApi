...
use hdmi_out_v1_01_a.user_logic;
...
entity hdmi_out is
  ...
  (
    ...
    --USER ports added here
		...
		-- user clock specific to the filter, so the hdmi output could have free clock source
  ...
  attribute SIGIS of SPLB_Rst      : signal is "RST";
	...
	attribute SIGIS of FILTER_PIXEL_CLOCK    : signal is "CLK";
...
begin
  ...
  ------------------------------------------
  USER_LOGIC_I : entity hdmi_out_v1_01_a.user_logic
    generic map
    (
