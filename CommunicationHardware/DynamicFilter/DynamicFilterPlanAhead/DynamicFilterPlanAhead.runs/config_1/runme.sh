...
EAStep ngdbuild -intstyle ise -p xc5vlx110tff1136-1 -dd _ngo -uc "config_1.ucf" "config_1.edf"
EAStep map -intstyle pa -w -pr b "config_1.ngd"
EAStep par -intstyle pa "config_1.ncd" -w "config_1_routed.ncd"
