...
EAStep ngdbuild -intstyle ise -p xc5vlx110tff1136-1 -dd _ngo -uc "config_2.ucf" "config_2.edf"
EAStep map -intstyle pa -w -pr b "config_2.ngd"
EAStep par -intstyle pa "config_2.ncd" -w "config_2_routed.ncd"
EAStep trce -intstyle ise -o "config_2.twr" -v 30 -l 30 "config_2_routed.ncd" "config_2.pcf"
EAStep xdl -secure -ncd2xdl -nopips "config_2_routed.ncd" "config_2_routed.xdl"
