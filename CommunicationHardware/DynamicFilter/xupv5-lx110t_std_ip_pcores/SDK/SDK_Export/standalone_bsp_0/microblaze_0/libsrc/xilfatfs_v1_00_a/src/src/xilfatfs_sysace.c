...
//<julio>
/*
 * changed due to compilation error
...
int init_ace()
{
	...
	// <julio>
	/*
	 * changed due to compilation error from XFALSE to FALSE
	 * <previous>
	 * while ((Result = XSysAce_Lock(&Ace, XFALSE)) != XST_SUCCESS)
	 * </previous>
	 */
	while ((Result = XSysAce_Lock(&Ace, FALSE)) != XST_SUCCESS);
	// <julio>
