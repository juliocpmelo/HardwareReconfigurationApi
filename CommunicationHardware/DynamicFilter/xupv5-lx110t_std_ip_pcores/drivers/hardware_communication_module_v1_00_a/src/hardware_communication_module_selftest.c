/*****************************************************************************
* Filename:          D:\Users\Julio\Downloads\Atlys_HDMI_PLB_demo\project/drivers/hardware_communication_module_v1_00_a/src/hardware_communication_module_selftest.c
* Version:           1.00.a
* Description:       Contains a diagnostic self-test function for the hardware_communication_module driver
...
#include "hardware_communication_module.h"
...
XStatus HARDWARE_COMMUNICATION_MODULE_SelfTest(void * baseaddr_p)
{
  ...
  HARDWARE_COMMUNICATION_MODULE_mWriteSlaveReg0(baseaddr, 0, 1);
  Reg32Value = HARDWARE_COMMUNICATION_MODULE_mReadSlaveReg0(baseaddr, 0);
  ...
  HARDWARE_COMMUNICATION_MODULE_mWriteSlaveReg1(baseaddr, 0, 2);
  Reg32Value = HARDWARE_COMMUNICATION_MODULE_mReadSlaveReg1(baseaddr, 0);
  ...
  HARDWARE_COMMUNICATION_MODULE_mWriteSlaveReg2(baseaddr, 0, 3);
  Reg32Value = HARDWARE_COMMUNICATION_MODULE_mReadSlaveReg2(baseaddr, 0);
  ...
  HARDWARE_COMMUNICATION_MODULE_mWriteSlaveReg3(baseaddr, 0, 4);
  Reg32Value = HARDWARE_COMMUNICATION_MODULE_mReadSlaveReg3(baseaddr, 0);
  ...
  HARDWARE_COMMUNICATION_MODULE_mWriteSlaveReg4(baseaddr, 0, 5);
  Reg32Value = HARDWARE_COMMUNICATION_MODULE_mReadSlaveReg4(baseaddr, 0);
