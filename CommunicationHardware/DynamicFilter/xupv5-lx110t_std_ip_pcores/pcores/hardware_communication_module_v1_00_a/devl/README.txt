...
Peripheral Summary:
  ...
  XPS project / EDK repository               : D:\Users\Julio\Downloads\Atlys_HDMI_PLB_demo\project
  logical library name                       : hardware_communication_module_v1_00_a
  top name                                   : hardware_communication_module
  version                                    : 1.00.a
  type                                       : PLB (v4.6) slave
...
- HDL source file(s)
  ...
  hdl/vhdl/hardware_communication_module.vhd
...
- XPS interface file(s)
  ...
  data/hardware_communication_module_v2_1_0.mpd
  ...
  data/hardware_communication_module_v2_1_0.pao
...
- ISE project file(s)
  ...
  devl/projnav/hardware_communication_module.ise
  ...
  devl/projnav/hardware_communication_module.cli

    This is the TCL command line file used to generate the .ise file.

- XST synthesis file(s)

  devl/synthesis/hardware_communication_module_xst.scr
  ...
  devl/synthesis/hardware_communication_module_xst.prj
...
- Driver source file(s)
  ...
  src/hardware_communication_module.h
...
-user needs to add these to repositories path in SDK (Xilinx Tools-->Repositories)
  ...
  data/hardware_communication_module_v2_1_0.mdd

    This is the Microprocessor Driver Definition file.

  data/hardware_communication_module_v2_1_0.tcl
...
plbv46_slave_single_v1_01_a
	D:\Users\Julio\Downloads\Atlys_HDMI_PLB_demo\project\C:\Xilinx\14.4\ISE_DS\EDK\hw\XilinxProcessorIPLib\pcores\plbv46_slave_single_v1_01_a\doc\plbv46_slave_single.pdf
