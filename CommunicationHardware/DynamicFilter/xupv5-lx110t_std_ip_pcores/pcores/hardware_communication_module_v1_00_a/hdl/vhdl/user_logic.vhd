...
-- Date:              Mon May 27 13:34:50 2013 (by Create and Import Peripheral Wizard)
...
architecture IMP of user_logic is
  ...
  component CommunicationHardware
	generic(
	...
	end component CommunicationHardware;
  ------------------------------------------
...
begin
  ...
  slv_read_ack      <= Bus2IP_RdCE(0) or Bus2IP_RdCE(1) or Bus2IP_RdCE(2) or Bus2IP_RdCE(3) or Bus2IP_RdCE(4);
	...
	communicationHardware_inst : CommunicationHardware
	generic map(
		communicationBussInput_width => C_SLV_DWIDTH,
		communicationBussOutput_width => C_SLV_DWIDTH,
		communicationAddress_width => C_SLV_DWIDTH
	)
	port map (
		clk => communicationHardware_clk,
		registerAddress => slv_reg0,
		registerInValue => slv_reg1,
    registerOutValue => slv_reg2,
		mode => slv_reg3(C_SLV_DWIDTH-1)	
	);	
