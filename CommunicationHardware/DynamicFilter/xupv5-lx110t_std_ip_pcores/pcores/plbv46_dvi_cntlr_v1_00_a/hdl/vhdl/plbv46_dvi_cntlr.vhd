------------------------------------------------------------------------------
-- plbv46_dvi_cntlr.vhd - entity/architecture pair
------------------------------------------------------------------------------
-- IMPORTANT:
...
entity plbv46_dvi_cntlr is
  generic
  (
    -- ADD USER GENERICS BELOW THIS LINE ---------------
    --USER generics added here
    C_DCR_BASEADDR 					  		 : std_logic_vector(0 to 9)     := "0010000000";
    C_DCR_HIGHADDR  	             : std_logic_vector(0 to 9)     := "0010000001";
    C_DEFAULT_TFT_BASE_ADDR		  	 : std_logic_vector(0 to 10)    := "11110000000";
    C_DPS_INIT 	 					  			 : integer     		 						:= 1;
    C_ON_INIT 	 						  		 : integer            				:= 1;
...
end entity plbv46_dvi_cntlr;

------------------------------------------------------------------------------
-- Architecture section
------------------------------------------------------------------------------

architecture IMP of plbv46_dvi_cntlr is
  ...
  ------------------------------------------
  component plbv46_dvi_cntlr_logic is
    generic
    (
      -- ADD USER GENERICS BELOW THIS LINE ---------------
      --USER generics added here
      ...
      C_DCR_BASEADDR 					  		  : std_logic_vector(0 to 9)     := "0010000000";
      C_DCR_HIGHADDR  	              : std_logic_vector(0 to 9)     := "0010000000";
      C_DEFAULT_TFT_BASE_ADDR		  	  : std_logic_vector(0 to 10)    := "11110000000";
      C_DPS_INIT 	 					  			  : integer     		 						:= 1;
      C_ON_INIT 	 						  		  : integer            				:= 1;
  ...
  end component plbv46_dvi_cntlr_logic;
...
begin
  ...
  ------------------------------------------
  x_plbv46_dvi_cntlr_logic : plbv46_dvi_cntlr_logic
  generic map
    (
