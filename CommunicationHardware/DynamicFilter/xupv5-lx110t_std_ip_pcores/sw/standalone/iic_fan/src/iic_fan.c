...
* FAN controller on the ML505/ML506/ML507 board.
*
* The fan controller is at address 0x2C on the IIC_SCL_MAIN, IIC_SDA_MAIN
* IIC chain.
*
* @note
*
* This example re-uses code created for access to a generic IIC EEPROM.
* References to an EEPROM can be interpreted to mean the fan controller chip. 
*
* <pre>
* </pre>
*
 ...
 */
#define EEPROM_TEST_START_ADDRESS   0x3E
...
int main (void)
{
   ...
   XUartNs550_SetLineControlReg(UART_BASEADDR, XUN_LCR_8_DATA_BITS); 
    ...
    print("IIC Dynamic mode FAN CONTROLLER access example - ");
    /*
...
*********************/
    ...
    xil_printf("\r\nCalling FAN CONTROLLER ReadByte Routine\r\n");
    /*
     * Read from the Fan controller.
     */
