...
* IIC interface of the DVI connector on the ML505/ML506/ML507 board.
*
* An attempt to access address 0x50 on the IIC_SCL_VIDEO_F, IIC_SDQA_VIDEO_F
* IIC chain wired to the DVI connector is made.
*
* @note
*
* This example re-uses code created for access to a generic IIC EEPROM.
* References to an EEPROM can be interpreted to mean the device attached
* to the DVI connector's IIC pins. 
*
* <pre>
* </pre>
*
...
int main (void)
{
   ...
   XUartNs550_SetLineControlReg(UART_BASEADDR, XUN_LCR_8_DATA_BITS); 
    ...
    print("IIC Dynamic mode DVI CONNECTOR access example - ");
    /*
...
*********************/
    ...
    xil_printf("\r\nCalling DVI CONNECTOR ReadByte Routine\r\n");
    /*
