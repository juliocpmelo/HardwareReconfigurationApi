...
int tftpserver_application_thread()
{
	...
	while (1) {
		...
		sys_thread_new("TFTP", process_tftp_request, (void*)args, 4096,DEFAULT_THREAD_PRIO);
	}
...
{
	xil_printf("\n\r\n\r-----lwIP TFTP Server ------\n\r");
	xil_printf("Upload or download files from the Memory File System to your localhost\n\r");
