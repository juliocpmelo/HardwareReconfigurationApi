...
* VGA input controller on the ML505/ML506/ML507 board.
*
* The VGA input controller is at address 0x4C on the IIC_SCL_VIDEO_F,
* IIC_SDA_VIDEO_F IIC chain.
*
* @note
*
* This example re-uses code created for access to a generic IIC EEPROM.
* References to an EEPROM can be interpreted to mean the clock generator chip. 
*
* <pre>
* </pre>
*
 ...
 */
#define EEPROM_TEST_START_ADDRESS   0x28
...
int main (void)
{
   ...
   XUartNs550_SetLineControlReg(UART_BASEADDR, XUN_LCR_8_DATA_BITS); 
    ...
    print("IIC Dynamic mode VGA INPUT CONTROLLER access example - ");
    /*
...
*********************/
    ...
    xil_printf("\r\nCalling VGA INPUT CONTROLLER ReadByte Routine\r\n");
    /*
