...
int main()
  ...
  XTft_SetPos(&Tft, 5, 0);
  XTft_WriteColorString(&Tft, "*** Put Your Own ACE File Here! ***", 0x0000FF80, 0x00404040);

  xil_printf ("*** Put Your Own ACE File Here! ***\r\n\r\n");

  LCDOn();
  LCDInit();
  LCDPrintString ("Put Your Own ACE","File Here!");
