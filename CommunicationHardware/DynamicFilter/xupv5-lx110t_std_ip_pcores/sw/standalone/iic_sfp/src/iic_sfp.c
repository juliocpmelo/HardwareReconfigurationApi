...
* SFP module on the ML505/ML506/ML507 board.
*
* The SFP module is at address 0x50 on the IIC_SCL_SFP, IIC_SDA_SFP
* IIC chain.
*
* @note
*
* This example re-uses code created for access to a generic IIC EEPROM.
* References to an EEPROM can be interpreted to mean the SFP module. 
*
* <pre>
* </pre>
*
...
int main (void)
{
   ...
   XUartNs550_SetLineControlReg(UART_BASEADDR, XUN_LCR_8_DATA_BITS); 
    ...
    print("IIC Dynamic mode SFP access example - ");
    /*
...
XStatus XIicLowLevelEepromDump()
{
    ...
    do
    {
         StatusReg = XIo_In32(IIC_2_BASE_ADDRESS + XIIC_SR_REG_OFFSET);
					   ...
					   Xuint8 ByteCount)
{
     ...
     */
    SentByteCount = XIic_DynSend(IIC_2_BASE_ADDRESS, EEPROM_ADDRESS, WriteBuffer,
 					  ...
 					  Xuint8 ByteCount)
{
    ...
    do
    {
    	...
    	StatusReg = XIo_In8(IIC_2_BASE_ADDRESS + XIIC_SR_REG_OFFSET);
    	if(!(StatusReg & XIIC_SR_BUS_BUSY_MASK))
    	{
    		SentByteCount = XIic_DynSend(IIC_2_BASE_ADDRESS, EEPROM_ADDRESS,
     ...
     * Receive the data.
     */
    ReceivedByteCount = XIic_DynRecv(IIC_2_BASE_ADDRESS, EEPROM_ADDRESS,
    								 BufferPtr, ByteCount);
...
XStatus XIicLowLevelEepromInit()
{
    ...
    * Initialize the IIC Core.
    */
   Status = XIic_DynInit(IIC_2_BASE_ADDRESS);
